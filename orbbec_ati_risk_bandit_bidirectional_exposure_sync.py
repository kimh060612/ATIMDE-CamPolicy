...
from orbbec_ati_risk_bandit_bidirectional_exposure import (
    configure_bidirectional_exposure_parser,
    validate_bidirectional_exposure_args,
)
...
def build_experiment(
    ...
    return RiskBanditBidirectionalExposureSyncExperiment(
        config,
        capture_runner,
        predictor,
        policy,
...
def main(argv: Sequence[str] | None = None) -> int:
    experiment: RiskBanditBidirectionalExposureSyncExperiment | None = None
    exit_code = 0
    try:
