...
CSV_FIELDS = (
    ...
    "brightness_guard_mode", "brightness_state", "brightness_state_changed",
    "brightness_p10", "brightness_p50", "brightness_p90", "brightness_p99",
    "brightness_shadow_ratio", "brightness_luma_clip_ratio",
    "brightness_channel_clip_ratio", "brightness_overexposed_tile_ratio",
    "brightness_allowed_cell_count", "brightness_prefer_brighter",
    "brightness_recovery_cell_id", "brightness_force_recovery",
    "brightness_recovery_available",
