...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Local pairwise Orbbec camera control with current-score reuse."
    )
...
def build_experiment(args: argparse.Namespace) -> LocalSearchUpdateExperiment:
    ...
    return LocalSearchUpdateExperiment(
